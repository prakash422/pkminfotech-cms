...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const canonicalPath = `/rrb/${examType}/mock-test`
  const title = `${name} Mock Test | pkminfotech`
  const description = `Free ${name} full-length mock tests with timer and instant result. Practice before the real Railway exam.`
  return {
    title,
    description,
