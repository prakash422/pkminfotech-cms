...
async function getEnglishBlogs(): Promise<Blog[]> {
  try {
    ...
    return blogs
      .filter((blog: Blog) => blog.status === 'published' && blog.category === 'english')
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
            ...
            <nav className="hidden md:flex items-center space-x-4 lg:space-x-6" role="navigation">
              ...
              <Link href="/english" className="font-medium transition-colors flex items-center px-3 py-2 rounded-lg text-green-600 bg-green-50">
                English Blog
              </Link>
