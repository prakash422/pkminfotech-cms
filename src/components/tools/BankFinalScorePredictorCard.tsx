        ...
        <div className="card-body p-3 p-md-4">
          <div className="row g-4">
            <div className="col-md-6 col-lg-5">
              <h3 className="h6 fw-semibold mb-3">Enter Your Marks</h3>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <div className="d-flex gap-2 align-items-center">
                  <input
                    ...
                    onChange={(e) => setPrelimsObtained(e.target.value)}
                    placeholder="65"
                  />
                  ...
                  <input
                    ...
                    max={200}
                    value={prelimsTotal}
                    onChange={(e) => setPrelimsTotal(e.target.value)}
                  />
                </div>
              </div>
              <div className="mb-4">
                ...
                <div className="d-flex gap-2 align-items-center">
                  <input
                    ...
                    step={0.5}
                    value={mainsObtained}
                    onChange={(e) => setMainsObtained(e.target.value)}
                    placeholder="125"
                  />
                  <span className="text-secondary small">/</span>
                  <input
                    ...
                    max={300}
                    value={mainsTotal}
                    onChange={(e) => setMainsTotal(e.target.value)}
                  />
                </div>
              </div>
              <button
